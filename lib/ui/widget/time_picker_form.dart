    ...
    return GestureDetector(
      ...
      child: AbsorbPointer(
        child: Container(
            ...
            decoration: const BoxDecoration(border: Border(bottom: BorderSide(color: gray4)), color: gray7),
            child: Align(
                alignment: Alignment.center,
                child: Text(timeFormat, style: const TextStyle(color: gray2, fontSize: 16)))),
      ),
    );
  }
